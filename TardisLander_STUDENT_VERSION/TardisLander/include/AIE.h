...
typedef enum SpriteBlendModes
{
	_ZERO					= 0,			// = GL_ZERO
	_ONE					= 1,			// = GL_ONE
	_SRC_COLOR				= 0x0300,		// = GL_SRC_COLOR
	_DST_COLOR				= 0x0306,		// = GL_DST_COLOR
	_ONE_MINUS_SRC_COLOR	= 0x0301,		// = GL_ONE_MINUS_SRC_COLOR
	_ONE_MINUS_DST_COLOR	= 0x0307,		// = GL_ONE_MINUS_DST_COLOR
